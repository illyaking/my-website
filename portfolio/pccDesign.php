...
<body>
    ...
    <main>
        ...
        <div class="container-fluid">
                            ...
                            <li class="category-2">
                                ...
                                <div id="image-4" class="lightbox">
                                    ...
                                    <div class="lightbox-caption">
                                        <!-- Lightbox image description -->
                                        <h3>City Block</h3>
                                        <p>CAS233 Beginning Illustrator</p>
                                    </div>
                                </div>
                            </li>
                            <!-- / Image 4 -->
            ...
            <!--/.row-->
            <p>Additional images are located at <a href="https://pics.illyaking.com/index.php?/category/24" target="_blank">https://pics.illyaking.com/index.php?/category/24</a></p>
        </div><!-- /.container-fluid-->
    </main><!-- /.main -->
